...
const Dashboard = () => {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        if (userData.autopoolPayReciever !== "0x0000000000000000000000000000000000000000") {
          const receiverData = await contract.methods.users(userData.autopoolPayReciever).call();
  ...
  const generateReferralLink = (id) => `http://localhost:3000?id=${id}`;
            ...
            <div className="card-reg">
              <div className="card-body-reg">
                ...
                <form className="forms-sample" onSubmit={handleSubmit}>
                  ...
                  />
                  {loading && <div className="loader-text">Processing Transaction...</div>}
                  <button className="btn mt-3 submitbtn_ w-100" type="submit" disabled={loading}>
              ...
              <div className="card-body-reg">
                ...
                <div className="form-group w-100">
                  <input
                    ...
                    readOnly
                  />
                  <button className="btn mt-3 submitbtn_ w-100" onClick={handleCopied}>
